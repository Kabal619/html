        	...
        	<table id="structure">
            	<tr>
                    ...
                    <td id="page">
                        ...
                        <?php if (!empty($errors)) { echo "<p class=\"errors\">"; echo "Please Review the following fields <br />";
                        ...
                        <form action = "edit_subject.php?subj=<?php echo urlencode($sel_subject['id']); ?>" method ="post">
                            ...
                            <p>Position:
                            	<select name="position">
                                	<?php 
										//Subject count+1 cause we're adding a page
                        ...
                        <div style="margin-top: 2em; border-top: 1 px solid#000000:">
